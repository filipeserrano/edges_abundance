...
```{r}
# plotting the predicted values for the best model
plot_increase = plot(ggeffects::ggpredict(increase_model, terms = c("reldist_leading_scaled", "Group"), typical = "weighted_mean", interval = "confidence"))+
  scale_fill_manual(values = cols1) +
  scale_color_manual(values = cols1) + theme_classic() +
...
ggsave(plot = last_plot(),"slope_speciesgroup_increasing_leading.jpg")
